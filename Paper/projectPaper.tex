...
\begin{document}
    ...
    We followed the details of the Full Velocity Difference Model in The Full Velocity Difference Model (FVDM) is given by the acceleration function: 
    \begin{equation} 
